...
<header>
    ...
    <div class="container2">
        <div class="row">
            ...
            <div class="col-25">
                <div class="container">
                    <h4>Cart  <span class="price" style="color:black"><i class="fa fa-shopping-cart"></i> <b>{{$carts2}}</b></span>
                    </h4>
                    @foreach($items as $item)
                    <p><a href="#" class='c'>{{$item->name}}</a> <span class="price">{{$item->price}}</span></p>
                    @endforeach
                    <hr>
                    <p><b>Total </b><span class="price" style="color:black"><b>{{$carts1}}</b></span></p>
                </div>
