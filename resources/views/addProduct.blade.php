...
<header>
    ...
    <section style="background-color:#55acee; width: 1100px; margin: auto;">
        <div class="container center-block">
            ...
            <fieldset>
                    <!-- Form Name -->
                    <legend style="text-align: center;font-size: 32px; font-weight: bold; text-decoration: underline; padding: 30px 0px;">ADD PRODUCTS</legend>
            ...
            <div class="thank-you hidden">Product Added Successfully!!!</div>
        </div>
    </section>
    <br><br>
