                ...
                <div class="col-md-3 col-sm-6">
                    <div class="product-grid">
                        <div class="product-image">
                            <a href="#" class="image">
                                <a href="singleProduct.html"><img class="pic-1" src = "{{$item->image1}}"></a>
                                <a href="singleProduct.html"><img class="pic-2" src = "{{$item->image2}}"></a>
                            </a>
                ...
                @foreach ($bestProducts as $bestProduct)
                    <div class="col-md-3 col-sm-6">
                        <div class="product-grid">
                            <div class="product-image">
                                <a href="#" class="image">
                                    <a href="singleProduct.html"><img class="pic-1" src = "{{$bestProduct->image1}}"></a>
                                    <a href="singleProduct.html"><img class="pic-2" src = "{{$bestProduct->image2}}"></a>
                                </a>
                                <a href="" class="product-like-icon"><i class="fa fa-heart"></i></a>
                                <ul class="product-links">
                                    <li><a href="#"><i class="fa fa-heart"></i></a></li>
                            ...
                            <div class="product-content">
                                <h3 class="title"><a href="#">{{$bestProduct ->name}}</a></h3>
                                <div class="price">{{'Rs.'.$bestProduct -> price}}</div>
                            </div>
                        </div>
                    </div>
                @endforeach
