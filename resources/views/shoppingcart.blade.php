                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                                    ...
                                    <div class="bg-image hover-overlay hover-zoom ripple rounded"
                                       ...
                                       <img src = "{{$cart->image1}}" class="w-100" />
                                ...
                                <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                                    ...
                                    <button onclick="delfromCart({{$cart->idUser}},{{$cart->idproducts}}); refreshPage()" type="button" class="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="Remove item">
                                        <i class="fa fa-trash"></i>
                                    </button>
                                    <button onclick="addWishList({{$cart->idUser}},{{$cart->idproducts}}); refreshPage()" type="button" class="btn btn-danger btn-sm mb-2" data-mdb-toggle="tooltip" title="Move to the wish list">
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                ...
                                <li
                                    ...
                                    <span><strong>{{'Rs.'.$carts1}}</strong></span>
                                </li>
                            </ul>
