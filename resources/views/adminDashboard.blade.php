...
<header>
        ...
        <div class="row">
            <div class="col-md-4 col-sm-6">
                <div class="card" style="margin-top: 20px;">
                    <img src="images/add.png" class="card-img-top" alt="Fissure in Sandstone"/>
                    <div class="card-body">
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card" style="margin-top: 20px;">
                    <img src="images/u.png" class="card-img-top" alt="Fissure in Sandstone"/>
                    <div class="card-body">
                      <h5 class="card-title">UPDATE A PRODUCTS</h5>
            ...
            <div class="col-md-4 col-sm-6">
                <div class="card" style="margin-top: 20px;">
                    <img src="images/delete.png" class="card-img-top" alt="Fissure in Sandstone"/>
                    <div class="card-body">
                      <h5 class="card-title">DELETE A PRODUCTS</h5>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-12">
                <h1 style="margin-top: 20px;">SALES REPORTS</h1>
                <canvas id="cookieChart" width="250" height="180"></canvas>
            </div>
            <div class="col-md-6 col-12">
                <h1 style="margin-top: 20px;">USERS REPORTS</h1>
                <canvas id="lineChart" height="180" width="250"></canvas>
            </div>
        </div>
    </div>
    ...
    <script src="js/adminDashborad.js"></script>
</body>
