                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            ...
                            @foreach ($wishlist as $wish)
                                <tr>
                                    <td width="45%">
                                        <div class="display-flex align-center">
                                            <div class="img-product">
                                                <img class="pic-1" src = "{{$wish->image1}}">
                                            </div>
                                    ...
                                    <td width="15%" class="price">{{'Rs.'.$wish -> price}}</td>
                                    <td width="15%"><span class="in-stock-box">In Stock</span></td>
                                    <td width="15%"><button class="round-black-btn small-btn" onclick="addtoCart({{$wish->idUser}},{{$wish->idproducts}}); delfromWish({{$wish->idUser}},{{$wish->idproducts}}); refreshPage()">Add to Cart</button></td>
