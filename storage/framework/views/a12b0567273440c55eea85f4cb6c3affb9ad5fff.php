                        ...
                        <table cellpadding="0" cellspacing="0" border="0" width="100%">
                            ...
                            <?php $__currentLoopData = $wishlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wish): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    <td width="45%">
                                        <div class="display-flex align-center">
                                            <div class="img-product">
                                                <img class="pic-1" src = "<?php echo e($wish->image1); ?>">
                                            </div>
                                    ...
                                    <td width="15%" class="price"><?php echo e('Rs.'.$wish -> price); ?></td>
                                    <td width="15%"><span class="in-stock-box">In Stock</span></td>
                                    <td width="15%"><button class="round-black-btn small-btn" onclick="addtoCart(<?php echo e($wish->idUser); ?>,<?php echo e($wish->idproducts); ?>); delfromWish(<?php echo e($wish->idUser); ?>,<?php echo e($wish->idproducts); ?>); refreshPage()">Add to Cart</button></td>
...
</html><?php /**PATH C:\Users\Aech\Downloads\web\attire\resources\views/wishlist.blade.php ENDPATH**/ ?>