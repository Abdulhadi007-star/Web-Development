                            ...
                            <div class="row">
                                <div class="col-lg-3 col-md-12 mb-4 mb-lg-0">
                                    ...
                                    <div class="bg-image hover-overlay hover-zoom ripple rounded"
                                       ...
                                       <img src = "<?php echo e($cart->image1); ?>" class="w-100" />
                                ...
                                <div class="col-lg-5 col-md-6 mb-4 mb-lg-0">
                                    <!-- Data -->
                                    <p><strong><?php echo e($cart ->name); ?></strong></p>
                                    <p>Color: Black</p>
                                    <p>Size: M</p>

                                    <button onclick="delfromCart(<?php echo e($cart->idUser); ?>,<?php echo e($cart->idproducts); ?>); refreshPage()" type="button" class="btn btn-primary btn-sm me-1 mb-2" data-mdb-toggle="tooltip" title="Remove item">
                                        <i class="fa fa-trash"></i>
                                    </button>
                                    <button onclick="addWishList(<?php echo e($cart->idUser); ?>,<?php echo e($cart->idproducts); ?>); refreshPage()" type="button" class="btn btn-danger btn-sm mb-2" data-mdb-toggle="tooltip" title="Move to the wish list">
                                ...
                                <div class="col-lg-4 col-md-6 mb-4 mb-lg-0">
                                    ...
                                    <p class="text-start text-md-center">
                                        <strong><?php echo e('Rs.'.$cart -> price); ?></strong>
                                    </p>
                                    <!-- Price -->
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <ul class="list-group list-group-flush">
                                <li
                                    ...
                                    <span><?php echo e('Rs.'.$carts1); ?></span>
                                </li>
                                ...
                                <li
                                    ...
                                    <span><strong><?php echo e('Rs.'.$carts1); ?></strong></span>
                                </li>
                            </ul>

                            <button type="button" class="btn btn-primary btn-lg btn-block">
                                <a href="checkout" style="color: white; text-decoration: none;"> Proceed to checkout</a>
                            </button>
                        </div>
...
</html><?php /**PATH C:\Users\Aech\Downloads\web\attire\resources\views/shoppingcart.blade.php ENDPATH**/ ?>