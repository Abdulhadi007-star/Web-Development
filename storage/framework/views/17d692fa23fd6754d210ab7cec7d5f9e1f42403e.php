...
<head>
    ...
    <!-- <script defer src="js/indexlogin.js"></script> -->
</head>
<body>
<header>
        ...
        <div class="container">
            <form id="form" action="/login" method="POST">
                ...
                <div class="input-control">
                    <label class="fa fa-user fa-lg" for="username" style="padding: 10px 0px"> Username</label>
                    <input id="name" name="name" type="text" placeholder="Abc12">
                    <p><?php echo e($em ?? ''); ?></p>
                    <div class="error"></div><br>
                </div>
                
                <div class="input-control">
                    <label class="fa fa-lock fa-lg" for="password" style="padding: 10px 0px"> Password</label>
                    <input id="password"name="password" type="password" placeholder="******">
                    <p><?php echo e($em ?? ''); ?></p>
                    <div class="error"></div><br>
                </div>
                
                <button type="submit" style= "position: relative; top:5px">Sign In</button>
                <br><br>
                <a class="fa fa-user fa-lg" style="text-decoration:none;" href="register.html"> Don't have an Account? Sign Up!</a>
                <!-- <p><?php echo e($em ?? ''); ?></p> -->
            </form>
        </div>
    </section>
...
</html><?php /**PATH C:\Users\Aech\Downloads\web\attire\resources\views/login.blade.php ENDPATH**/ ?>