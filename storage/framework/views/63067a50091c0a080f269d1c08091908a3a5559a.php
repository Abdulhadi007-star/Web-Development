...
<header>
    ...
    <div id="hd">
        ...
        <a href="home.html" title="back to home page">Product Name</a>
        <span class="breadcrumb__divider" aria-hidden="true">/</span>
        <span>Details</span>
    </div>
    ...
    <section class="container sproduct my-5 pt-2">
        <div class="row mt-5">
            ...
            <div class="col-lg-6 col-md-12 col-12">
                ...
                <h2 style="color:red ;"><?php echo e('Rs.'.$item -> price); ?></h2>
                <select class="my-3">
...
</html><?php /**PATH C:\Project\attire\resources\views/singleProduct.blade.php ENDPATH**/ ?>